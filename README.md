...
_A compiled (ongoing) dictionary of cryptography terms, algorithms, protocols, and concepts. Feel free to contribute!_

## Overview

This repository serves as a comprehensive reference guide for cryptography-related terminology. Whether you're a student, researcher, security professional, or enthusiast, you'll find clear explanations of cryptographic concepts, algorithms, and protocols.

**Credit**: This dictionary draws significant inspiration from the work of [Jean Philippe Aumasson](https://github.com/veorq), a renowned cryptographer and security researcher.

## Contents

This dictionary currently contains **29 entries** covering:
- **Cryptographic algorithms**: AES, RSA, Argon2, and more
- **Protocols and standards**: TLS, GSM ciphers (A5/x), AKA
- **Cryptanalysis techniques**: Adaptive attacks, algebraic cryptanalysis
- **Conferences and community**: ASIACRYPT, and references to other major cryptography conferences
- **Historical context**: Important events and figures in cryptography

## Quick Navigation

Browse entries alphabetically:
- [**Numbers & Symbols**](#2013) (2013, 65537)
- [**A**](#a50) (A5/0 through Axolotl)
- More sections to be added as the dictionary grows

## How to Use This Dictionary

- **Search**: Use your browser's search function (Ctrl+F or Cmd+F) to find specific terms
- **Links**: Click on hyperlinked terms and references for additional information
- **Cross-references**: Look for "_See [Term]_" references to explore related concepts
...
Ways to contribute:
- Add new cryptography terms and definitions
- Improve existing entries with more detail or clarity
- Fix typos, broken links, or formatting issues
- Add references to academic papers, specifications, or authoritative sources
